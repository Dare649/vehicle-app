      ...
      <table className="w-full text-sm text-left mt-5 ">
        <thead className="capitalize border-b-2 border-primary-2">
          <tr >
            ...
            {columns.map((col) => (
              <th key={col.key} className="px-6 py-3 capitalize text-primary-2 ">
                {col.label}
              </th>
            ))}
            {actions && <th className="px-6 py-3 capitalize text-primary-2">action</th>}
          </tr>
        </thead>
        <tbody>
          {currentData.length === 0 ? (
            ...
            currentData.map((item) => (
              ...
              >
                ...
                {columns.map((col) => (
                  <td key={col.key} className="px-6 py-4 text-primary-1">
                    {item[col.key]}
                  </td>
                ))}
                {actions && (
